      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mx-10">
        <div class="flex flex-col">
          ...
          <div class="flex flex-row gap-x-5 mb-16">
            <div class="w-1/2">
            <img class="h-28 w-full object-cover rounded-md" src="{{asset('storage/' . $item->image)}}"
              alt="Post image">
            </div>
            <div class="w-1/2 flex flex-col">
            <div class="short-title">{{ $item->shortTitle() }}</div>
            <div class="date mt-2">{{Carbon\Carbon::parse($item->published_at)->isoFormat('D MMMM Y')}}</div>
            </div>
          </div>
          </a>
        @endforeach
        ...
        <div class="col-span-2 ml-4">
          <div class="flex flex-col">
            <div class="title-visi mb-3">Sejarah Perusahan</div>
            <div class="flex flex-row items-center">
              ...
              <!-- <p class="ml-3 detail-date">{{\Carbon\Carbon::parse($item->published_at)->isoFormat('Y-M-D')}}</p> -->
              <p class="ml-3 detail-date">2025-02-06</p>
            ...
            <div style="font-size: 14px;">
              ...
              <p>Sumber penyediaan air minum berasal dari sumber mata air di Kawung Carang yang terletak di daerah
                Kabupaten Banyumas dengan debit hanya 3 liter/detik.</p><br />
              <p>Dalam perkembangan selanjutanya, setelah Pabrik Gula tutup pada tahun sebelum 1940, maka air minum yang
                ada dimanfaatkan untuk memenuhi keperluan kantor-kantor/instansi pemerintah dan masyarakat. Adapun
                jumlah pelanggannya sampai dengan tahunn 1970 hanya sebanyak 80 Sambungan Rumah (SR).</p><br />
              <p class="mb-2">Pada tahun 1968/1969. PDAM Purbalingga mendapat bantuan dari Direktorat Jendral Cipta
                Karya berupa fasilitas sarana dan prasarana air bersih sebagai berikut :</p>
              <ul class="ml-5" style="list-style-type: disc;">
                <li>Pembuatan bangunan penangkap air di sumber mata air di Desa Walik yang terletak 8 km ke utara kota
                  Purbalingga.</li>
                <li>Pembuatan Reservoir di Desa Karanglewas yang terletak 4 km ke arah selatan dari bangunan penangkap
                  air di Desa Walik.</li>
                <li>Pemindahan pipa distribusi yang berasal dari perbatasan Kabupaten Banyumas dan dipasang di bangunan
                  Penangkap air ke Reservoir serta sampai di kota Purbalingga.</li>
              </ul>
              <br />
              <p>Sejak tahun 1969 PDAM Purbalingga dapat melayani kebutuhan air minum bagi masyarakat kota Purbalingga
                secara mandiri. Tetapi karena terbatasnya sarana dan prasarana penyediaan air minum yang ada, maka
                sampai dengan akhir tahun 1988 jumlah pelanggan hanya 1.231 Sambungan Rumah (SR).</p>
              <p>Selanjutnya pada tahun Anggaran 1985/1986, 1986/1987 dan 1967/1988, PDAM Purbalingga memperoleh bantuan
                dari Direktorat Air Bersih berupa sarana dan prasarana air bersih dan pembangunan gedung untuk kantor
                yang terinci sebagai berikut :</p>
              <ul class="ml-5" style="list-style-type: disc;">
                <li>Tahun 1985/1986</li><span>Pembuatan bangunan Aerasi yang terletak dan berdampingan dengan bagunan
                  Reservoirr di desa Karanglewas.<br />
                ...
                <li>Tahun 1986/1987</li><span>Pemasangan pipa distribusi dan Sambungan Rumah (SR) sebanyak 550 SL.
                  <li>Tahun 1987/1988</li><span>Pembangunan gedung kantor dan penambahan Sambungan Rumah sebanyak 500
                    SL.</span>
                  <li>Tahun 1988/1989
                  </li><span>Pemasangan Sambungan Rumah (SR) Sebanyak 500 SL.</span>
              </ul>
              <br />
              <p>Pengelolaan penyediaan air bersih dalam bentuk Perusahaan Daerah Air Minum Kabupaten Daerah Tingkat II
                Purbalingga dimulai sejak didirikan berdasarakan Peraturan Daerah Kabupaten Purbalingga Nomor 1 Tahun
                1968 tentang Pendirian Perusahaan Daerah Air Minum Kabupaten Purbalingga tanggal 27 Agustus 1968.</p>
              <br />
              <p>Sejak didirikan system air bersih pada tahun 1927 sampai dengan 26 Agustus 1968 masih Saluran Air Minum
                (SAM) yang merupakan bagian dari pada Dinas Pekerjaan Umum Kabupaten Purbalingga.</p><br />
              <p>Fungsi PDAM Kabupaten Purbalingga adalah mengusahakan penyedian air bersih untuk kebutuhan masyarakat
                di Kabupaten Purbalingga dan sekitarnya. Dalam rangka menjalankan fungsi tersebut kegiatan perusahaan
                meliputi :</p>
              <ul class="ml-5" style="list-style-type: disc;">
                <li>Mengolah sumber air untuk memperoleh air bersih dan menyalurkan kepada pelanggan.</li>
                <li>Membangun jaringan distribusi dan transmisi dalam rangka untuk mengoptimalkan penyaluran air bersih
                  kepada masyarakat di wilayah kerjanya, dan</li>
                <li>Melakukan pemeliharaan jaringan distribusi dan transmisi untuk menekan kebocoran/kehilangan air.
                </li>
              </ul>
            </div>
          </div>
