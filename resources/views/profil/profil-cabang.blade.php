        ...
        <div class="flex flex-col">
          <div>
            <ul>
              ...
              <a href="{{route('profil.sejarah-perusahaan')}}"><li class="list-profil flex flex-row items-center mb-2">
                <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M7.157 7.71114L1.5 13.3681L0.0859985 11.9541L5.036 7.00414L0.0859985 2.05414L1.5 0.640137L7.157 6.29714C7.34447 6.48466 7.44978 6.73897 7.44978 7.00414C7.44978 7.2693 7.34447 7.52361 7.157 7.71114Z" fill="#6E6A6A"/>
                </svg>
              ...
              <a href="/post/{{$post->id}}">
                  <div class="flex flex-row gap-x-5 mb-16">
                      ...
                      <div class="w-1/2 flex flex-col">
                        ...
                        <div class="date mt-3">{{\Carbon\Carbon::parse($post->published_at)->isoFormat('D MMMM Y')}}</div>
                      </div>
                  </div>
              </a>
          @endforeach
      ...
      <div class="col-span-2 ml-4">
        <div class="flex flex-col">
          ...
          <div class="flex flex-row items-center">
              ...
              <p class="ml-3 detail-date">{{\Carbon\Carbon::parse($post->published_at)->isoFormat('Y-M-D')}}</p>
          ...
          <p class="py-4 text-md text-gray-700 dark:text-gray-400">Cabang dan Unit IKK adalah pelayanan yang dikelola PDAM Kabupaten Purbalingga pada tiap Ibu Kota Kecamatan di wilayah pelayanan.</p>
