    ...
    <div>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mx-10">
        ...
        <div class="col-span-2 ml-4">
          <div class="flex flex-col">
            <div class="title-visi mb-1">Visi Misi</div>
            <div class="flex flex-row items-center mb-5">
              ...
              <!-- <p class="ml-3 detail-date">{{\Carbon\Carbon::parse($item->published_at)->isoFormat('Y-M-D')}}
              </p> -->
            ...
            <div class="block-visimisi">
              <div class="flex flex-col items-center mx-20 my-8">
