            ...
            <form wire:submit.prevent="addReply" class="my-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="py-2 px-4 mb-4 bg-gray-100 rounded-lg rounded-t-lg dark:bg-gray-800">
                        <textarea rows="6" wire:model.defer="replyText" class="px-0 w-full text-sm text-gray-900 bg-gray-100 border-0 focus:ring-0 focus:outline-none dark:text-white dark:placeholder-gray-400 dark:bg-gray-800" placeholder="Tulis balasan..."></textarea>
                    </div>
