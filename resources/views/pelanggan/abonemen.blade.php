  ...
  <div class="flex flex-col font-poppins mb-28">
    ...
    <div>
      ...
      <div class="col-span-2 ml-4">
        <div class="flex flex-col">
          <div class="title-visi mb-4">Abonemen</div>
          ...
          <img class="my-4" src={{ asset('storage/background/tarif-abonemen.png') }}>
          <p class=""><b>ABONEMEN </b>merupakan biaya tetap yang dikenakan kepada pelanggan setiap bulan sebagai
              bagian dari layanan penyediaan air bersih. Biaya ini mencakup komponen pemeliharaan infrastruktur,
              distribusi air, dan pelayanan pelanggan, terlepas dari jumlah air yang digunakan.</p>
            <p class="mt-3">Tujuannya adalah untuk memastikan ketersediaan layanan yang berkesinambungan dan mendukung
              operasional perusahaan daerah tersebut. Besaran abonemen ditentukan berdasarkan golongan pelanggan atau
              jenis layanan yang digunakan.</p>
        </div>
        </div>
      </div>
    </div>
