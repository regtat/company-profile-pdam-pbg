<x-layout>
  <div class="flex flex-col font-poppins mb-28">
    <div class="h-[315px] relative">
      ...
      <div class="absolute top-10 left-10 text-white">
        <p class="font-extrabold leading-none text-left font-poppins profil">Pelanggan</p>
        <div class="block bg-white w-full h-1 my-5"></div>
        <p>Tarif Dasar</p>
      </div>
    </div>
    <div>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mx-10 mt-10 mb-10">
        <div class="flex flex-col">
          <div>
            <ul>
              <li class="font-bold text-2xl text-black mb-4">Pelanggan</li>
              <a href="{{route('pelanggan.abonemen')}}"><li class="list-profil flex flex-row items-center mb-2">
                ...
                <span class="pl-2">Abonemen</span>
              </li></a>
              <a href="{{route('pelanggan.tarif-dasar')}}"><li class="list-profil flex flex-row items-center mb-2">
                <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M7.157 7.71114L1.5 13.3681L0.0859985 11.9541L5.036 7.00414L0.0859985 2.05414L1.5 0.640137L7.157 6.29714C7.34447 6.48466 7.44978 6.73897 7.44978 7.00414C7.44978 7.2693 7.34447 7.52361 7.157 7.71114Z" fill="#6E6A6A"/>
                </svg>
                <span class="pl-2">Tarif Dasar</span>
              </li></a>
            </ul>
      ...
      <div class="col-span-2 ml-4">
        <div class="flex flex-col">
          <div class="title-visi mb-4">Tarif Dasar</div>
          ...
          <img class="my-4" src={{ asset('storage/background/tarif-dasar.png') }}>
            <p class=""><b>TARIF DASAR </b>pada Perumda Tirta Perwira Kabupaten Purbalingga adalah tarif per satuan volume air yang ditetapkan untuk pelanggan berdasarkan kategori tertentu, seperti rumah tangga, niaga, sosial, atau industri.</p>
          <p class="mt-3">Tarif ini dihitung dalam satuan meter kubik (m³) dan mencerminkan biaya penggunaan air sesuai dengan kebijakan perusahaan daerah. Penetapan tarif dasar mempertimbangkan aspek keberlanjutan layanan, pemeliharaan infrastruktur, serta keadilan bagi pelanggan dengan memperhatikan kemampuan bayar dan kebutuhan masing-masing golongan.</p>
        </div>
        </div>
      </div>
    </div>
