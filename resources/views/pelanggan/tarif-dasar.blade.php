      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mx-10">
        ...
        <div class="col-span-2 ml-4">
          <div class="flex flex-col">
            ...
            <p class=""><b>TARIF DASAR </b>pada Perumda Tirta Perwira Kabupaten Purbalingga adalah tarif per satuan
              volume air yang ditetapkan untuk pelanggan berdasarkan kategori tertentu, seperti rumah tangga, niaga,
              sosial, atau industri.</p>
            <p class="mt-3">Tarif ini dihitung dalam satuan meter kubik (m³) dan mencerminkan biaya penggunaan air
              sesuai dengan kebijakan perusahaan daerah. Penetapan tarif dasar mempertimbangkan aspek keberlanjutan
              layanan, pemeliharaan infrastruktur, serta keadilan bagi pelanggan dengan memperhatikan kemampuan bayar
              dan kebutuhan masing-masing golongan.</p>
          </div>
        </div>
      </div>
    </div>
